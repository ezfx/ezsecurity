/*
 * copy from http://www.cs.princeton.edu/introcs/72regular/Wildcard.java.html
 * 修改了一下代码，把'.'匹配一个字符改成'?'匹配一个字符,注释没有修改
 */
package wangjg.commons.utils.regex;
...
public class Wildcard { 
   ...
   ***********************************************************************/
   ...
   public static void main(String[] args) {
		System.out.println(Wildcard.matches("*abc**xyz*", "abc1xyz*"));
		System.out.println(Wildcard.matches("12345", "12345"));
		System.out.println(Wildcard.matches("12345*", "12345"));
		System.out.println(Wildcard.matches("1*1*1", "1a1b1"));
		System.out.println(Wildcard.matches("1*1*1", "1*a*1b1"));
		System.out.println(Wildcard.matches("1.*1*1?", "1.*..a1b1_"));
   }
